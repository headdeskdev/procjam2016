...
del lock.tmp
cl /I..\external\include ..\code\platform\platform_windows.cpp /FmFePrototype.map %COMPILE_OPTIONS% /FePrototype.exe %PLATFORM_LIBS% /link %LINK_OPTIONS%
